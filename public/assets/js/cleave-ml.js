!function () {
    ...
    function o(n) {
        return n = a(n.a), r(n, function (n, t) {
            return n.b - t.b
        }), n
    }
    ...
    function p(n, t) {
        for (var e = o(n.j()), l = 0; l < e.length; l++) {
            ...
            if (null != t.a[i]) {
                n.b && delete n.b[r.b];
                var a = 11 == r.a || 10 == r.a;
                if (r.g) for (var r = c(t, i) || [], u = 0; u < r.length; u++) {
                    var s = n, f = i, h = a ? r[u].clone() : r[u];
...
*/
    ...
    function E(n) {
        this.H = RegExp(" "), this.C = "", this.m = new e, this.w = "", this.i = new e, this.u = new e, this.l = !0, this.A = this.o = this.F = !1, this.G = A.b(), this.s = 0, this.b = new e, this.B = !1, this.h = "", this.a = new e, this.f = [], this.D = n, this.J = this.g = B(this, this.D)
    }
    ...
    function R(n) {
        for (var t = n.f.length, e = 0; e < t; ++e) {
            ...
            a = n;
            var u = r, o = g(u, 1);
            if (-1 != o.indexOf("|")) a = !1; else {
                o = o.replace(on, "\\d"), o = o.replace(sn, "\\d"), l(a.m);
                var s;
                s = a;
                var u = g(u, 2), f = "999999999999999".match(o)[0];
                f.length < s.a.b.length ? s = "" : (s = f.replace(new RegExp(o, "g"), u), s = s.replace(RegExp("9", "g"), " ")), 0 < s.length ? (a.m.a(s), a = !0) : a = !1
            }
    ...
    function C(n, t) {
        ...
        switch (n.u.b.length) {
            ...
            case 3:
                ...
                n.A = !0;
            default:
                return n.A ? (P(n) && (n.A = !1), n.b.toString() + n.a.toString()) : 0 < n.f.length ? (e = q(n, t), r = M(n), 0 < r.length ? r : (F(n, n.a.toString()), R(n) ? V(n) : n.l ? D(n, e) : n.i.toString())) : L(n)
        }
    }
    ...
    function L(n) {
        ...
        if (3 <= t.length) {
            for (var e = n.o && 0 == n.h.length && 0 < m(n.g, 20) ? c(n.g, 20) || [] : c(n.g, 19) || [], l = e.length, r = 0; r < l; ++r) {
                var i = e[r];
                0 < n.h.length && N(g(i, 4)) && !h(i, 6) && null == i.a[5] || (0 != n.h.length || n.o || N(g(i, 4)) || h(i, 6)) && fn.test(g(i, 2)) && n.f.push(i)
            }
    ...
    function H(n) {
        var t = n.u.toString(), e = new RegExp("^(?:\\+|" + h(n.g, 11) + ")"), e = t.match(e);
    ...
    function P(n) {
        ...
        var t, r = new e;
        n:{
            if (t = n.a.toString(), 0 != t.length && "0" != t.charAt(0)) for (var i, a = t.length, u = 1; 3 >= u && u <= a; ++u) if (i = parseInt(t.substring(0, u), 10), i in nn) {
                r.a(t.substring(u)), t = i;
                break n
            }
            t = 0
        }
        return 0 != t && (l(n.a), n.a.a(r.toString()), r = j(t), "001" == r ? n.g = $(n.G, "" + t) : r != n.D && (n.g = B(n, r)), n.b.a("" + t).a(" "), n.h = "", !0)
    }

    function q(n, t) {
        var e = n.m.toString();
        if (0 <= e.substring(n.s).search(n.H)) {
            var r = e.search(n.H), e = e.replace(n.H, t);
    ...
    var U = 1, Y = 2, k = 3, J = 4, K = 6, O = 16, Z = 18;
    ...
    }, t(x, w), x.prototype.b = function (n, t) {
...
*/
    ...
    var en = {
        ...
        "۸": "8",
        "۹": "9"
    }, ln = RegExp("[+＋]+"), rn = RegExp("([0-9０-９٠-٩۰-۹])"), an = /^\(?\$1\)?$/, un = new _;
    b(un, 11, "NA");
    var on = /\[([^\[\]])*\]/g, sn = /\d(?=[^,}][^,}])/g,
        fn = RegExp("^[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*(\\$\\d[-x‐-―−ー－-／  ­​⁠　()（）［］.\\[\\]/~⁓∼～]*)+$"),
        pn = /[- ]/;
    E.prototype.K = function () {
        this.C = "", l(this.i), l(this.u), l(this.m), this.s = 0, this.w = "", l(this.b), this.h = "", l(this.a), this.l = !0, this.A = this.o = this.F = !1, this.f = [], this.B = !1, this.g != this.J && (this.g = B(this, this.D))
